...
public class INFPIiKT extends JFrame {
    public INFPIiKT() {
        ...
        lab1  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab1();  dispose(); });
        lab2  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab2();  dispose(); });
        lab3  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab3();  dispose(); });
        lab4  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab4();  dispose(); });
        lab5  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab5();  dispose(); });
        lab6  .addActionListener(e -> { new com.itmo.studenthelper.INF.lab6();  dispose(); });
